...
![X (formerly Twitter) Follow](https://img.shields.io/twitter/follow/blockedpaths?style=social&link=https%3A%2F%2Fx.com%2FBlockedPaths)

![X Follow](https://shieldcn.dev/x/follow/BlockedPath.svg?variant=branded&size=xs&mode=light)
